...
class _$OrdersImpl implements _Orders {
  ...
  @override
  String toString() {
    return 'Orders(uid: $uid, products: $products, total: $total, orderId: $orderId, address: $address, isAccepted: $isAccepted, isCancelled: $isCancelled, isDelivered: $isDelivered, date: $date)';
  }
